#!/usr/bin/env python3
"""Finalize DAG v6.1 test evidence, provenance and artifact hashes."""
...
def main() -> int:
    ...
    atomic_json(
        test_results_path,
        {
            "schema": "dag-v6.1-test-results-v1",
            "status": "PASS",
            **totals,
            "pytest_xml": {
    ...
    builder = REPO / "case_224gpu_pp14_cp2_a2a/scripts/build_dag_v61_kernel_calibration.py"
    finalizer = Path(__file__).resolve()
    test_source = REPO / "case_224gpu_pp14_cp2_a2a/tests/test_dag_v61_kernel_calibration.py"
    trace_parser = REPO / "src/x10000_analysis/mfu_trace.py"
    code_paths = [config_path, builder, finalizer, test_source, trace_parser]
